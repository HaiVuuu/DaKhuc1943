...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Kết thức replay") action EndReplay(confirm=True)
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("Kết thúc") action Quit(confirm=not main_menu)
...
screen history():
    ...
    use game_menu(_("Lịch sử"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0, spacing=gui.history_spacing):
...
screen help():
    ...
    use game_menu(_("Hỗ trợ"), scroll="viewport"):
